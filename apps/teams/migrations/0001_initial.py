    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Name of the team', max_length=100, verbose_name='Name')),
                ('slug', models.SlugField(help_text='Team slug', unique=True, verbose_name='Slug')),
                (
                    'description',
                    models.TextField(
                        blank=True, help_text='Description of the team', null=True, verbose_name='Description'
                    ),
                ),
                (
                    'created_by',
